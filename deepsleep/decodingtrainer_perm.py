...
def pgd_l2_untargeted_mostlikely(model, X, epsilon=1.0, alpha=0.05, num_iter=50, randomize=False):
    if randomize:
...
def pgd_linf_untargeted_mostlikely_defense(model, sess, feed_dict, epsilon=0.2, stepsize=0.1, num_iter=50, randomize=False):
