...
class NonSeqDataLoader(object):
    ...
    def __init__(self, data_dir, n_folds, fold_idx, data='sleep-edf-sc'):
    ...
    def load_train_data(self, n_files=None):
        ...
        if self.data is'sleep-edf-sc':
            ...
            train_files = np.setdiff1d(npzfiles, val_files[self.fold_idx])
            subject_files = val_files[self.fold_idx]
...
class SeqDataLoader(object):
    ...
    def load_subject_data(data_dir, subject_idx, n_folds):
        ...
        val_files = val_files[subject_idx]
        ...
        print "Load validation set:"
        data, labels = load_npz_list_files(val_files)
